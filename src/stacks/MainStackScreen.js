...
function ConSellStack() {
  return (
    <ContentSellerScreenStack.Navigator initialRouteName="Seller" hearderMode="none">
      <ContentSellerScreenStack.Screen name="Seller" component={SellerScreen} />
      <ContentSellerScreenStack.Screen name="ContentSeller" component={ContentSellerScreen}
      />
